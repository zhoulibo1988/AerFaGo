...
import sine.framework.generator.util.SqlExecutorHelper;
import sine.framework.generator.util.StringHelper;
import sine.framework.generator.util.SystemHelper;
import sine.framework.generator.util.XMLHelper;
...
public class GeneratorControl {
	private boolean isOverride = Boolean.parseBoolean(GeneratorProperties.getProperty("isOverride", "false")); 
