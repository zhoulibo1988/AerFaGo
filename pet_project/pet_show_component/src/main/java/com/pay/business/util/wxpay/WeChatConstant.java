...
public class WeChatConstant {
	 ...
	 * app支付的应用ID
	 */
	//protected static final String APPPAY_APPID = "wxfb28dce18bb0b0f4";
	protected static final String APPPAY_APPID = "wxf1e29bc9747ce6c1";
	
	/**
	 * 商户号
	 */
	//protected static final String APPPAY_MCHID = "1425308602";
	 ...
	 */
	//protected static final String KEY = "nw5IHpj1umiCl0lmLvoitebVBtWKQGtm";
