...
import com.ivan.web.controller.system.UploadController;
...
public class TestController {
	...
	public Map<String, Object> uploadApkIpa(@RequestParam(value = "file", required = false) MultipartFile fileinfo,
			HttpServletRequest request) throws Exception {
