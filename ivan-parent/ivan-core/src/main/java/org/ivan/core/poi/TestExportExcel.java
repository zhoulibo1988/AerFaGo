 ...
 * @version v1.0
 * @param <T>
 *            应用泛型，代表任意一个符合javabean风格的类 注意这里为了简单起见，boolean型的属性xxx的get器方式为getXxx(),而不是isXxx() byte[]表jpg格式的图片数据
 */
public class TestExportExcel<T> {
    ...
    public void exportExcel(String[] headers, Collection<T> dataset, OutputStream out) {
        exportExcel("列表", headers, dataset, out, "yyyy-MM-dd HH:mm:ss");
    }
...
//                        }
    ...
    // // 测试学生
    // TestExportExcel<T> ex = new TestExportExcel<T>();
    ...
    // // 测试图书
    // TestExportExcel<Book> ex2 = new TestExportExcel<Book>();
    // String[] headers2 = { "图书编号", "图书名称", "图书作者", "图书价格", "图书ISBN","图书出版社", "封面图片" };
    // List<Book> dataset2 = new ArrayList<Book>();
    // try {
    // // BufferedInputStream bis = new BufferedInputStream(
    // // new FileInputStream("V://book.bmp"));
//			String url = System.getProperty("user.dir")+"/src/img/book.png";
...
////			OutputStream out = new FileOutputStream("c://home/export2003_a.xls");
////			OutputStream out2 = new FileOutputStream("c://home/export2003_b.xls");
//			//当前用户桌面
