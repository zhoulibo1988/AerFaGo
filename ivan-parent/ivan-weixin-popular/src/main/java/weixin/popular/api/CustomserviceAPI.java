...
public class CustomserviceAPI extends BaseAPI {
	 ...
	 * @return BaseResult
	 */
	public static BaseResult newkfaccountAdd(String access_token, String kf_account, String nickname) {
		String postJsonData = String.format("{\"kf_account\":\"%1s\",\"nickname\":\"%2s\"}", 
					kf_account, 
					nickname);
		HttpUriRequest httpUriRequest = RequestBuilder.post()
				.setHeader(jsonHeader)
	 ...
	 * @return BaseResult
	 */
	public static BaseResult newkfaccountUpdate(String access_token, String kf_account, String nickname) {
		String postJsonData = String.format("{\"kf_account\":\"%1s\",\"nickname\":\"%2s\"}", 
					kf_account, 
					nickname);
		HttpUriRequest httpUriRequest = RequestBuilder.post()
	 ...
	 * @return BaseResult
	 */
	public static BaseResult bindingWeChat(String access_token, String kf_account, String invite_wx) {
		String postJsonData = String.format("{\"kf_account\":\"%1s\",\"invite_wx\":\"%2s\"}", 
					kf_account,
					invite_wx);
		HttpUriRequest httpUriRequest = RequestBuilder.post()
				.setHeader(jsonHeader)
				.setUri(BASE_URI + "/customservice/kfaccount/inviteworker")
				.addParameter(PARAM_ACCESS_TOKEN, API.accessToken(access_token))
				.setEntity(new StringEntity(postJsonData, Charset.forName("utf-8")))
				.build();
		return LocalHttpClient.executeJsonResult(httpUriRequest, BaseResult.class);
	...
	public static void main(String[] args) {
		String token="7KZI12cfDzdBUVKvyIqbjxIML-vGQ6eZwIoVvCk862XvUx6aCrLgWSgX9wfng09SluLF4CHibgJ7KN4tufNxBVevQblFmF15NH73or8MNK_OETlDotItWnjEitpfVL0PEZWeAMDPKH";
		File file=new File("d:/AAAAA.jpg");
		String kf_account="zlb1988@quanminjinfu";
		BaseResult baseResult =	kfaccountUploadHeadimg(token, kf_account, file);
